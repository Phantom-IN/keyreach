...
from tools.guardrails import ai_ban, network_isolation, no_secrets, read_only, workflows
from tools.guardrails.base import Violation, report

CHECKS: dict[str, Callable[[], list[Violation]]] = {
    # First, because a workflow that does not parse cannot run any of the
    # others — and GitHub reports that as one annotation with no context.
    "workflows": workflows.check,
    "ai_ban": ai_ban.check,
